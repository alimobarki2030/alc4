...
l1:[
  ...
  {q:"Please _______ after you cook.",o:["did","clean up","live","end"],a:1,en:"clean up = tidy/organize",ar:"نظّف / رتّب",tr:"من فضلك نظّف بعد ما تطبخ."},
  ...
  {q:"Sally goes _______ on the bus every day.",o:["city","downtown","yesterday","library"],a:1,en:"downtown = city center",ar:"وسط المدينة",tr:"سالي تروح وسط المدينة بالباص كل يوم."},
  ...
  {q:"What time does class _______?",o:["visit","start","clean","again"],a:1,en:"class starts = begins",ar:"الدرس يبدأ",tr:"الساعة كم تبدأ الحصة؟"},
  ...
  {q:"Bob: Do you live in San Antonio? Lou: No, I am _______ here.",o:["visiting","starting","watching","cleaning"],a:0,en:"visiting = here temporarily",ar:"زائر = موجود مؤقتاً",tr:"بوب: تسكن في سان أنطونيو؟ لو: لا، أنا بس زائر هنا."},
  {q:"Sam: Did you watch the baseball game on TV? Tom: Yes, _______.",o:["I watch","I did","I did watched","I watching"],a:1,en:"Short answer: Yes, I did.",ar:"الإجابة القصيرة",tr:"سام: تفرجت على مباراة البيسبول بالتلفاز؟ توم: إي، تفرجت."},
  {q:"Kay: Did Paul play baseball yesterday? May: No, he _______.",o:["not did","I did","did not","no did plays"],a:2,en:"No, he did not. = didn't",ar:"لا، هو لم يفعل",tr:"كاي: لعب بول بيسبول أمس؟ ماي: لا، ما لعب."},
  {q:"Bob visited Chicago last year, and he wants to go _______ this year.",o:["again","long","like","basketball"],a:0,en:"again = one more time",ar:"مرة أخرى",tr:"بوب زار شيكاغو السنة الماضية، ويبي يروح مرة ثانية هالسنة."},
  ...
  {q:"There are eleven players on a football _______.",o:["game","sport","team","play"],a:2,en:"11 players = a team",ar:"11 لاعب = فريق",tr:"فيه أحد عشر لاعباً في فريق كرة القدم."},
  {q:"My brother is a doctor. He _______ in a big hospital downtown.",o:["cleans","works","visits","ends"],a:1,en:"works = his job location",ar:"يعمل هناك",tr:"أخوي دكتور. يشتغل في مستشفى كبير وسط المدينة."},
  {q:"On Saturday, let's play _______.",o:["basketball","restaurant","town","visit"],a:0,en:"You play basketball",ar:"تلعب كرة السلة",tr:"يوم السبت، خلنا نلعب كرة السلة."},
  {q:"Ben: Did you watch the new _______ on TV last night? Tim: No, I went downtown.",o:["ball","show","city","restaurant"],a:1,en:"watch a show on TV",ar:"تشاهد برنامجاً على التلفاز",tr:"بين: تفرجت على البرنامج الجديد بالتلفاز البارحة بالليل؟ تيم: لا، رحت وسط المدينة."},
  {q:"Mr. Gregg is at the office from 7:00 a.m. to 7:00 p.m. He works _______.",o:["all night","all year long","all day long","every day"],a:2,en:"7am to 7pm = all day long",ar:"من الصباح للمساء = طول اليوم",tr:"السيد جريج بالمكتب من الساعة 7 صباحاً إلى 7 مساءً. يشتغل طول اليوم."},
],
l2:[
  ...
  {q:"Tim can't smoke. He doesn't have a _______.",o:["radio","report","cigarette","book"],a:2,en:"You smoke a cigarette",ar:"تدخّن سيجارة",tr:"تيم ما يقدر يدخن. ما عنده سيجارة."},
  {q:"I didn't know that airman's name. She didn't have her _______ on.",o:["cap","name tag","uniform","rank"],a:1,en:"Name tag has your name on it",ar:"بطاقة الاسم تحمل اسمك",tr:"ما كنت أعرف اسم تلك الجندية بسلاح الجو. ما كانت لابسة بطاقة اسمها."},
  {q:"Airmen always _______ officers.",o:["salute","report","bring","begin"],a:0,en:"Military rule: salute officers",ar:"التحية العسكرية للضباط",tr:"أفراد سلاح الجو دايم يحيّون الضباط."},
  {q:"My brother is a captain. He's _______.",o:["a civilian","in the military","a rank","on time"],a:1,en:"Captain = military rank → in the military",ar:"النقيب رتبة عسكرية → في الجيش",tr:"أخوي نقيب. هو في الجيش."},
  ...
  {q:"Col Smith _______ a pack of cigarettes every day.",o:["salutes","smokes","lives","reports"],a:1,en:"smokes a pack",ar:"يدخّن علبة",tr:"العقيد سميث يدخّن علبة سجاير كل يوم."},
  {q:"Class begins at 7:30 every day. It started at 7:40 this morning. This morning class _______.",o:["started on time","began early","didn't start on time","had 10 students"],a:2,en:"7:40 ≠ 7:30 → did not start on time",ar:"7:40 ≠ 7:30 → لم يبدأ في الوقت",tr:"الحصة تبدأ الساعة 7:30 كل يوم. اليوم بدأت الساعة 7:40. يعني الحصة ما بدأت في وقتها."},
  {q:"Put your _______ on your head.",o:["name tag","stripe","post","cap"],a:3,en:"You put a cap on your head",ar:"تضع القبعة على رأسك",tr:"حط قبعتك على راسك."},
  {q:"I'm tired! Let's take a _______.",o:["rank","break","pack","ID card"],a:1,en:"take a break = rest",ar:"خذ استراحة = ارتح",tr:"أنا تعبان! خلنا ناخذ استراحة."},
  {q:"Please _______ your books to class tomorrow.",o:["salute","report","bring","buy"],a:2,en:"bring = carry with you",ar:"أحضر = احمل معك",tr:"من فضلك أحضر كتبك للصف باكر."},
  ...
  {q:"I _______ class early yesterday.",o:["leaved","went out","left","gone from"],a:2,en:"leave → left (irregular)",ar:"leave→left فعل شاذ",tr:"طلعت من الصف بدري أمس."},
...
l3:[
  ...
  {q:"What time did you _______ this morning?",o:["woke up","wakes up","wake up","waking up"],a:2,en:"After Did, the main verb stays in base form: wake up",ar:"بعد Did يرجع الفعل لصيغة المصدر: wake up",tr:"الساعة كم صحيت اليوم الصبح؟"},
  {q:"Pvt Jones can _______ English, French, Japanese, and German.",o:["speak","speaks","spoke","speaking"],a:0,en:"can + base verb",ar:"can + فعل مجرد",tr:"الجندي جونز يقدر يتكلم إنجليزي وفرنسي وياباني وألماني."},
  ...
  {q:"May I go to the library?",o:["No, he didn't.","Yes, it is.","No, you must.","Yes, you may."],a:3,en:"May I? → Yes, you may.",ar:"May I? → Yes, you may.",tr:"أقدر أروح المكتبة؟ — إي، تقدر."},
  {q:"We wear _______.",o:["books","clothes","reports","posts"],a:1,en:"We wear clothes",ar:"نلبس ملابس",tr:"نحن نلبس ملابس."},
  {q:"I must _______ tonight.",o:["to study","study","studies","studying"],a:1,en:"must + base verb (no to)",ar:"must + فعل مجرد",tr:"لازم أذاكر الليلة."},
  {q:"These words are in alphabetical order:",o:["colonel, captain, cap, cigarette","pants, paragraph, pastel, pattern","shirt, skirt, shoes, she","coat, contraction, clothes, can"],a:1,en:"pants(pa-n), paragraph(pa-r), pastel(pa-s), pattern(pa-t)",ar:"pa-n → pa-r → pa-s → pa-t = ترتيب صحيح",tr:"هذي الكلمات مرتبة أبجدياً: pants, paragraph, pastel, pattern."},
  {q:"That man is an officer. Pvt Jones _______ salute officers.",o:["may","must not","must","didn't"],a:2,en:"Military rule: must salute officers always",ar:"يجب تحية الضباط دائماً",tr:"هذا الرجل ضابط. الجندي جونز لازم يحيّي الضباط."},
  {q:"I don't know French. This means:",o:["I can speak French","I must speak French","I can't speak French","I mustn't speak French"],a:2,en:"don't know = can't speak",ar:"لا أعرف = لا أستطيع التحدث",tr:"ما أعرف فرنسي. يعني: ما أقدر أتكلم فرنسي."},
  {q:"I like to sleep late on Saturday, but my children get up early. They are always _______ before I am.",o:["again","great","well","awake"],a:3,en:"awake = not sleeping",ar:"صاحٍ = غير نائم",tr:"أحب أنام متأخر يوم السبت، بس أولادي يقومون بدري. هم دايم صاحين قبلي."},
  {q:"It's cold. Where is my _______?",o:["coat","book","football","cigarette"],a:0,en:"You wear a coat when it's cold",ar:"تلبس المعطف عند البرد",tr:"الجو بارد. وين معطفي؟"},
  {q:"My son is not awake. He's _______.",o:["awake","bored","asleep","angry"],a:2,en:"Not awake = asleep",ar:"غير صاحٍ = نائم",tr:"ابني مو صاحي. هو نايم."},
  ...
  {q:"I'm very tired. I am going to _______ in lab this afternoon.",o:["put on","fall asleep","take off","wake up"],a:1,en:"fall asleep = go to sleep",ar:"fall asleep = يغفو",tr:"أنا تعبان جداً. بيغلبني النوم في المختبر بعد ظهر اليوم."},
  {q:"I can't swim very _______.",o:["again","well","true","all"],a:1,en:"swim well = with skill",ar:"يسبح بشكل جيد",tr:"ما أقدر أسبح زين."},
  {q:"My sister bought two _______ at the store.",o:["hat","dress","belts","scarf"],a:2,en:"two = plural → belts",ar:"اثنان = جمع → belts",tr:"أختي اشترت حزامين من المحل."},
  {q:"I must not write with a pen on the quiz. This means:",o:["I can write with a pen on the quiz","I am writing with a pen on the quiz","I cannot write with a pen on the quiz","I write with a pen on the quiz"],a:2,en:"must not = cannot",ar:"يجب ألّا = لا يمكن",tr:"لازم ما أكتب بالقلم الحبر في الاختبار. يعني: ما أقدر أكتب بالقلم الحبر بالاختبار."},
],
l4:[
  {q:"John works at a store. He's a _______.",o:["sailor","soldier","clerk","doctor"],a:2,en:"store worker = clerk",ar:"عامل متجر = clerk",tr:"جون يشتغل في محل. هو بائع (clerk)."},
  {q:"Ms. Moss _______ her students with English.",o:["works","reads","costs","helps"],a:3,en:"teacher helps students",ar:"المعلمة تساعد الطلاب",tr:"المعلمة موس تساعد طلابها بالإنجليزي."},
  {q:"Today is Monday. _______ is Wednesday.",o:["Tomorrow","The day before yesterday","The day after tomorrow","Yesterday"],a:2,en:"Monday + 2 days = Wednesday",ar:"الاثنين + يومين = الأربعاء",tr:"اليوم الاثنين. بعد باكر الأربعاء."},
...
const FINAL = dedupe_by_q([
  ...
  {q:"These words are in alphabetical order.",o:["Shirt, Sock, Sport, spring","Sweater, Summer, Shoe, Show","Season, Salute, Sentence, Scarf","Smoke, Sell, Suit, Start"],a:0,en:"Sh → So → Sp → sp = ascending alphabetical order",ar:"ترتيب أبجدي تصاعدي: Sh → So → Sp → sp",tr:"هذي الكلمات مرتبة أبجدياً: Shirt, Sock, Sport, spring.",lbl:'L3-24'},
  // Additional L4
  {q:"Pvt Jones can _______ four languages.",o:["speak","speaks","spoke","speaking"],a:0,en:"can + base verb",ar:"can + فعل مجرد",tr:"الجندي جونز يقدر يتكلم أربع لغات.",lbl:'L4-14'},
  {q:"What time did you _______ this morning?",o:["woke up","wakes up","wake up","waking up"],a:2,en:"After Did, the main verb stays in base form: wake up",ar:"بعد Did يرجع الفعل لصيغة المصدر: wake up",tr:"الساعة كم صحيت اليوم الصبح؟",lbl:'L4-15'},
  {q:"I'm very tired. I am going to _______ in lab this afternoon.",o:["put on","fall asleep","take off","wake up"],a:1,en:"fall asleep = go to sleep",ar:"fall asleep = يغفو",tr:"أنا تعبان جداً. بيغلبني النوم في المختبر بعد ظهر اليوم.",lbl:'L4-16'},
  {q:"My sister bought two _______ at the store.",o:["hat","dress","belts","scarf"],a:2,en:"two = plural → belts",ar:"اثنان = جمع → belts",tr:"أختي اشترت حزامين من المحل.",lbl:'L4-17'},
]);
EE.final=FINAL;
