...
// ROUTING MANIFEST
// ═══════════════════════════════════════
const SCREENS=['home','lscreen','fscreen','vtscreen','pscreen','ascreen','wscreen','pnscreen','modscreen','spscreen','tmscreen','ivscreen','ytscreen','mkscreen'];
const SCREEN_NAMES={home:'الرئيسية',lscreen:'درس',fscreen:'الاختبار النهائي',vtscreen:'اختبار المفردات',pscreen:'حروف الجر in·on·at',ascreen:'a·an·the',wscreen:'أدوات السؤال WH',pnscreen:'الضمائر وفعل الكينونة',modscreen:'الأفعال الناقصة',spscreen:'الإملاء',tmscreen:'الماضي وكلمات الزمن',ivscreen:'الأفعال الشاذة',ytscreen:'الاستماع',mkscreen:'مراجعة الأخطاء'};
